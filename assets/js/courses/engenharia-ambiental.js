...
const storage = window.KMStorage.forCourse({"progressKey":"skillTreeProgress_Ambiental","legacyProgressKey":"skillTreeProgress_Ambiental","glowKey":"skillTreeGlowEnabled_Ambiental","legacyGlowKey":"skillTreeGlowEnabled_Ambiental"});
        ...
        function saveState() {
            ...
            storage.setItem('skillTreeProgress_Ambiental', JSON.stringify(stateToSave));
        ...
        function loadState() {
            ...
            const savedStateJSON = storage.getItem('skillTreeProgress_Ambiental');
        ...
        // --- Settings Logic ---
        let isGlowEnabled = storage.getItem('skillTreeGlowEnabled_Ambiental');
        ...
        glowToggle.addEventListener('change', (e) => {
            if (e.target.checked) {
                ...
                storage.setItem('skillTreeGlowEnabled_Ambiental', 'true');
            } else {
                document.body.classList.add('disable-glow');
                storage.setItem('skillTreeGlowEnabled_Ambiental', 'false');
            }
        });

        resetButton.addEventListener('click', () => {
            // Remove os dados salvos para garantir um reset completo
            storage.removeItem('skillTreeProgress_Ambiental');
