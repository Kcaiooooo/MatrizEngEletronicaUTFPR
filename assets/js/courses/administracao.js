...
const storage = window.KMStorage.forCourse({"progressKey":"skillTreeProgress_Mecatronica_administracao","legacyProgressKey":"skillTreeProgress_Mecatronica","glowKey":"skillTreeGlowEnabled_Mecatronica_administracao","legacyGlowKey":"skillTreeGlowEnabled_Mecatronica"});
        ...
        function renderOptionalTrackHeaders() {
            ...
            const trackLabels = {
                '[1113]': 'Tópicos em Sustentabilidade e Gestão [1113]',
                '[1114]': 'Tópicos em Inovação e Tecnologia [1114]',
                '[1115]': 'Tópicos em Empreendedorismo [1115]',
                '[1116]': 'Tópicos em Formação Humana [1116]'
            };
            const trackOrder = ['[1113]', '[1114]', '[1115]', '[1116]'];
            ...
            trackOrder.forEach(groupId => {
                ...
                const yPos = Math.max(10, Math.min(90, (minY + maxY) / 2));
        ...
        function switchTab(newTab) {
            if (newTab === 'humanities') newTab = 'optional';
            activeTree = newTab;
